...
def main():
    ...
    print(mistral_model.config.hidden_size, mistral_model.config.hidden_size)
    ...
    tokenizer.save_pretrained("/home/barbosa/rihome/projects/TSLLaMA2/models/mistral_ts_projector")  # Save tokenizer
